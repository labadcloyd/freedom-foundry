const PROCESS = [
  { stage: "HEAT", title: "Consult", desc: "We learn your business, your customers, and what the site actually needs to do." },
  { stage: "SHAPE", title: "Design", desc: "A layout and look built around your trade, not a generic agency template." },
  { stage: "STRIKE", title: "Build", desc: "Development on Next.js or WordPress, whichever fits how you'll run the site." },
  { stage: "TEMPER", title: "Maintain", desc: "Launch, then ongoing care so the site holds up under real use." },
];
